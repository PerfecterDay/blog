...
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/usr/local/demo/com_gmas/lib
```
...
```
curl https://demogitlab.demo.net/demo-app-platform/trade/go-modu?go-get=1 | grep go-import

<html><head><meta name="go-import" content="demogitlab.demo.com.cn/demo-app-platform/trade git http://demogitlab.demo.com.cn/demo-app-platform/trade.git"></head><body>go get demogitlab.demo.com.cn/demo-app-platform/trade</body></html>

replace google.golang.org/grpc v1.62.1 => /usr/local/demo/com_gmas/go-modu
```
