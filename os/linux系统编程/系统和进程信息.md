...
555555554000-555555555000 r--p 00000000 00:24 15868106                   /usr/local/demo/com_gmas/a.out
555555555000-555555556000 r-xp 00001000 00:24 15868106                   /usr/local/demo/com_gmas/a.out
555555556000-555555557000 r--p 00002000 00:24 15868106                   /usr/local/demo/com_gmas/a.out
555555557000-555555558000 r--p 00002000 00:24 15868106                   /usr/local/demo/com_gmas/a.out
555555558000-555555559000 rw-p 00003000 00:24 15868106                   /usr/local/demo/com_gmas/a.out
...
555555554000-555555555000        r--p  00000000         00:24            15868106   /usr/local/demo/com_gmas/a.out
```
offset: 是映射文件的起始偏移量（以字节为单位）。这只对文件映射有意义。例如，堆栈或堆映射就不是文件映射，在这种情况下，偏移量为 0。在上例中，映射的是 /usr/local/demo/com_gmas/a.out 文件，偏移量为 0。
