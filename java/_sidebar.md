...
* [..](../_sidebar.md)
* [JVM](#)
  * [JVM、JRE及JDK的区别](/java/jvm/jvm工具/jvm-JVM、JRE及JDK的区别.md)
  * [内存管理](#)
    * [运行时数据区域](/java/jvm/jvm工具/自动内存管理/jvm-运行时数据区域.md)
    * [HotSpot虚拟机对象探秘](/java/jvm/jvm工具/自动内存管理/jvm-对象探秘.md)
    * [OOM实战](/java/jvm/jvm工具/自动内存管理/oom实战.md)
    * [GC虚拟机调优](https://www.baeldung.com/tag/garbage-collection)
      * [垃圾收集算法](/java/jvm/jvm工具/自动内存管理/gc/gc调优-垃圾收集算法.md)
      * [自适应优化](/java/jvm/jvm工具/自动内存管理/gc/gc调优-自适应优化.md)
      * [影响GC性能的因素](/java/jvm/jvm工具/自动内存管理/gc/gc调优-影响gc的因素.md)
      * [可用的主要GC](/java/jvm/jvm工具/自动内存管理/gc/gc调优-可用的gc.md)
      * [Parallel GC](/java/jvm/jvm工具/自动内存管理/gc/gc调优-parallel-gc.md)
      * [G1 GC](/java/jvm/jvm工具/自动内存管理/gc/gc调优-G1详解.md)
      * [G1 GC调优](/java/jvm/jvm工具/自动内存管理/gc/gc调优-G1调优.md)
      * [GC日志](/java/jvm/jvm工具/自动内存管理/gc/gc调优-gc日志.md)
      * [JFR和JMC](/java/jvm/jvm工具/自动内存管理/gc/jvm-JFR和JMC.md)
  * [虚拟机执行子系统](#)
    * [字节码文件结构](/java/jvm/jvm工具/虚拟机执行子系统/jvm-class字节码文件结构.md)
    * [类加载机制](/java/jvm/jvm工具/虚拟机执行子系统/jvm-类加载机制.md)
  * [java 命令选项详解](https://docs.oracle.com/en/java/javase/23/docs/specs/man/java.html)
  * [jvm工具](#)
    * [常用 Jvm 工具](/java/jvm/jvm工具/jvm-常用jvm工具.md)
    * [虚拟机性能监控与故障处理工具](/java/jvm/jvm工具/jvm-虚拟机性能监控与故障处理工具.md)
    * [Dump Heap堆](/java/jvm/jvm工具/jvm-dump堆.md)
    * [Jstack分析服务假死](/java/jvm/jvm工具/jstack/jvm-jstack.md)
...
* [IO](https://www.baeldung.com/java-io)
  ...
  * [Java对TLS的支持](/java/IO/java基础-https支持.md)
