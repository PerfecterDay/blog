...
```
curl --cacert ca.pem --cert xidemo.net.pem --key xidemo.net.key --location 'https://10.5.160.72:8443/am5/rest/query/user/findById' --header 'Content-Type: application/json' --data '{
